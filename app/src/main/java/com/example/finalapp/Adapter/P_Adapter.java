...
public class P_Adapter extends RecyclerView.Adapter<P_Adapter.MyViewHolder> {
    Context context;
    ...
    public P_Adapter(List<HomeCryptoData> homeCryptoData){
    ...
    @NonNull
    @Override
    public P_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_row, parent, false);
        return new P_Adapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull P_Adapter.MyViewHolder holder, int position) {
